...
[assembly: SuppressMessage("StyleCop.CSharp.DocumentationRules", "SA1633:The file header is missing or not located at the top of the file.", Justification = "File comes from a template with a different codestyle.", Scope = "type", Target = "~T:Microsoft.AzureExtension.Telemetry.TelemetryEventSource")]
[assembly: SuppressMessage("StyleCop.CSharp.LayoutRules", "SA1518:File is required to end with a single newline character", Justification = "File comes from a template with a different codestyle.", Scope = "type", Target = "~T:Microsoft.AzureExtension.Telemetry.TelemetryEventSource")]
[assembly: SuppressMessage("StyleCop.CSharp.MaintainabilityRules", "SA1402:File may only contain a single type", Justification = "Multiple types in this file are intentional.", Scope = "type", Target = "~T:Microsoft.AzureExtension.Telemetry.TelemetryEventSource")]
[assembly: SuppressMessage("StyleCop.CSharp.ReadabilityRules", "SA1413:Use trailing comma in multi-line initializers", Justification = "File comes from a template with a different codestyle.", Scope = "type", Target = "~T:Microsoft.AzureExtension.Telemetry.TelemetryEventSource")]
[assembly: SuppressMessage("Performance", "CA1852:Seal internal types", Justification = "File comes from a template with a different codestyle.", Scope = "type", Target = "~T:Microsoft.AzureExtension.Telemetry.TelemetryEventSource")]
